    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3">
          <svg className="w-6 h-6 text-gold mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 21v-8m0 0V3m0 10h9m-9 0H3m2 3h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
          </svg>
